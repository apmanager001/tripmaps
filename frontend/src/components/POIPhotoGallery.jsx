...
const POIPhotoGallery = ({
  ...
  const modalContent = (
    <div className="modal modal-open w-screen" onClick={handleClose}>
      <div
        className=" h-full w-screen bg-base-100 p-0 overflow-hidden relative z-[10000]"
      ...
      >
        ...
        <div className="flex flex-col lg:flex-row max-h-full">
            ...
            {poi.photos.length > 1 && (
              <>
                <button
                  ...
                  className="absolute left-2 sm:left-6 top-1/2 btn btn-ghost btn-circle"
                >
                  <ChevronLeft size={20} className="sm:w-7 sm:h-7" />
                </button>
                <button
                  onClick={handleNextPhoto}
                  className="absolute right-2 sm:right-6 top-1/2 btn btn-ghost btn-circle"
                >
          ...
          <div className="w-full h-full lg:w-80 bg-base-200 border-t lg:border-l lg:border-t-0 border-base-300 flex flex-col overflow-hidden mb-10">
            {/* Photo Details - Scrollable on mobile */}
            <div className="h-full p-3 sm:p-6 border-b border-base-300 ">
            ...
            {/* Photo Thumbnails - Scrollable when many photos */}
            {poi.photos.length > 1 && (
              <div className="p-3 sm:p-6 h-full">
                <div className="flex gap-2">
                  ...
                  <div className='badge-accent badge font-extrabold'>{poi.photos.length}</div>
                </div>
                <div className="overflow-auto max-h-[40vh] sm:max-h-[60vh] p-1">
                    ...
                    {poi.photos.map((photo, index) => (
                      ...
                      >
                        <img
                          ...
                          loading="lazy"
                        />
                        {photo?.isPrimary && !removePrimaryButton && (
