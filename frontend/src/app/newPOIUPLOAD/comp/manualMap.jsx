...
const ManualMap = ({ onSetCoords }) => {
  ...
  return (
    <div
      className={`my-10 md:my-0 relative transition-all duration-300 ${
    ...
    >
      ...
      <div className="absolute flex flex-col justify-center bottom-4 w-full items-center z-10 bg-white/40 py-2">
        <span className="text-xs font-mono mb-2 text-neutral">
          Lat: {markerCoords.lat.toFixed(3)}, Lng: {markerCoords.lng.toFixed(3)}
        </span>
        <button className="btn btn-primary btn-sm" onClick={handleSetCoords}>
          Use This Location
        </button>
      </div>
    </div>
